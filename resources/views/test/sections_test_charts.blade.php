...
@section("tag_head")
	<head>
		...
		<script src="{{asset('/js/main__test_charts.js')}}" type="module"></script>
		{{--	for debugging --}}
...
@section("javascript_array_for_charts")
	{{-- header__logo_search_auth_menu --}}
	@include("test.javascript_array_for_charts")
@endsection
...
@section("content")
	{{-- CONTENT --}}
	<content>
		@include("test.content_test_charts")
	</content>
@endsection
